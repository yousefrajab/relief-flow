    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
            @forelse($warehouses as $warehouse)
                <a href="{{ route('warehouses.show', $warehouse) }}" class="bg-white border border-ink-100 rounded-2xl p-5 space-y-3 hover:border-field-300 hover:shadow-md transition-all">
